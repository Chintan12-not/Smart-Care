  ...
  return (
    <footer className="bg-card text-foreground border-t border-border mt-auto relative">
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-30 flex flex-col gap-2.5">
        ...
        {/* Flashing WhatsApp Support Button */}
        <a
          ...
          className="group p-3 sm:p-3.5 rounded-full bg-emerald-500 text-white shadow-xl shadow-emerald-500/40 hover:scale-110 transition-all duration-300 flex items-center justify-center relative"
          title="Chat on WhatsApp"
        >
          {/* Flashing Outer Glowing Ring */}
          <span className="absolute -inset-1 rounded-full bg-emerald-400 opacity-75 animate-ping"></span>
          <span className="absolute inset-0 rounded-full bg-emerald-500 opacity-50 animate-pulse"></span>
          ...
          <span className="absolute -top-1 -right-1 flex h-3.5 w-3.5 z-20">
            ...
            <span className="relative inline-flex rounded-full h-3.5 w-3.5 bg-emerald-300 border-2 border-black"></span>
          </span>

          <svg className="h-5 w-5 sm:h-6 sm:w-6 fill-current relative z-10 animate-pulse text-white drop-shadow" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
