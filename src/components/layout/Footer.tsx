    ...
    <footer className="bg-card text-foreground border-t border-border mt-auto relative">
      ...
      <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3">
        ...
        {showScrollTop && (
          <button
            onClick={scrollToTop}
            className="p-3.5 rounded-full bg-background/80 backdrop-blur-md border border-border shadow-lg text-foreground hover:bg-muted transition-all select-none hover:-translate-y-0.5"
        ...
        <a
          ...
          className="p-3.5 rounded-full bg-cyan-500 text-black shadow-lg shadow-cyan-500/20 hover:scale-105 transition-transform flex items-center justify-center"
          title="Call Store"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="p-3.5 rounded-full bg-emerald-500 text-white shadow-lg shadow-emerald-500/20 hover:scale-105 transition-transform flex items-center justify-center"
